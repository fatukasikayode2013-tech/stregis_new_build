      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl lg:text-5xl text-[#1e3a5f] font-serif mb-4" style={{ fontFamily: 'Playfair Display, serif' }}>
              Booking Confirmed
            </h1>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-gray-700 mb-2"><strong>Name:</strong> [Guest Name]</p>
                  <p className="text-gray-700 mb-2"><strong>Email:</strong> [guest@email.com]</p>
                  <p className="text-gray-700 mb-2"><strong>Phone:</strong> [Phone Number]</p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-[#1e3a5f] mb-3">Stay Details</h3>
                  <p className="text-gray-700 mb-2"><strong>Check-in:</strong> [Check-in Date]</p>
                  <p className="text-gray-700 mb-2"><strong>Check-out:</strong> [Check-out Date]</p>
                  <p className="text-gray-700 mb-2"><strong>Room Type:</strong> [Room Type]</p>
                  <p className="text-gray-700 mb-2"><strong>Guests:</strong> [Number of Guests]</p>
                </div>
              </div>
            </div>
